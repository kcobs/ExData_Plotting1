...
plot4 <- function() {
    ...
    ##PLOT 1
    plot(study_data$timestamp,df$Global_active_power, type="l", xlab="", ylab="Global Active Power")
    ##PLOT 2
    plot(study_data$timestamp,df$Voltage, type="l", xlab="datetime", ylab="Voltage")
    ...
    #PLOT 4
    plot(study_data$timestamp,df$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
